...
```yaml
🎯 Open To:
  - Internships in Full-Stack / Mobile Development
...
A custom-designed music streaming app interface built using AI-assisted Android development workflows, focused on clean UI and intuitive playback controls.

| Aspect | Details |
|---|---|
| **Stack** | Android Studio, AI-Assisted Development, UI Design |
| **Scale** | Personal Project |
| **Performance** | Optimized for smooth scroll & playback UI |
| **Security** | N/A (UI prototype) |
| **Impact** | Strengthened mobile UI design & AI-tooling workflow skills |
| **Repository** | [View on GitHub](https://github.com/Stfuhxri) |

This project explored how AI-assisted coding tools can accelerate native Android UI development, with emphasis on layout structure, navigation, and visual polish for a media-focused app.
...
A personal portfolio website showcasing development projects, design work, and skills.
...
| **Security** | Static site, no backend exposure |
| **Impact** | Central hub for showcasing all projects & design work |
| **Repository** | [View on GitHub](https://github.com/Stfuhxri) |

Built from scratch using core web technologies to reinforce fundamentals in semantic HTML, responsive CSS, and vanilla JS interactivity.

</details>

<details>
<summary><b>🎨 Figma UI/UX Design Systems</b></summary>

<br/>

A collection of mobile and web interface designs, including prototypes and reusable design systems.

| Aspect | Details |
|---|---|
| **Stack** | Figma, UI/UX Principles |
| **Scale** | Multiple Mobile & Web Prototypes |
| **Performance** | N/A (Design Phase) |
| **Security** | N/A |
| **Impact** | Established design foundations later used in development projects |
| **Repository** | [View on GitHub](https://github.com/Stfuhxri) |

Focused on translating user needs into clean, consistent interfaces — covering wireframes, high-fidelity mockups, and interactive prototypes.
...
Working independently on personal and learning-driven projects spanning web development, mobile app design, UI/UX, and video content creation.

- Designed and prototyped mobile/web interfaces in Figma
- Built an Android music streaming UI using AI-assisted development tools
...
| Recognition | Details |
|---|---|
| 🎓 Diploma in AI & ML | Thiagarajar Polytechnic College |
| 🏛️ Pursuing B.E. CSE | SNS College of Technology |
| 🎨 Self-Taught Designer | Built multiple UI/UX prototypes & systems independently |
| 📱 AI-Assisted App Builder | Developed Android UI using AI-assisted workflows |
...
<img src="https://raw.githubusercontent.com/Stfuhxri/Stfuhxri/output/github-contribution-grid-snake-dark.svg" width="95%" />
...
Learning:
  ...
  - AI-Integrated Mobile App Development

Building:
  - Personal Portfolio v2
  - Music Streaming App (Feature Expansion)
  - UI/UX Design System Library
